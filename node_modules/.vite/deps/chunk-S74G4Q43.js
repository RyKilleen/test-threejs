...
function applyProps$1(instance, data) {
  ...
  for (let i2 = 0; i2 < changes.length; i2++) {
    ...
    if (isEvent) {
      ...
      if (!rootState.linear && currentInstance[key] instanceof Texture && currentInstance[key].format === RGBAFormat && currentInstance[key].type === UnsignedByteType) {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-S74G4Q43.js.map
